...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/21 17:24:35 by fgeorgan          #+#    #+#             */
/*   Updated: 2021/01/10 11:46:10 by fgeorgan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	put_zero(char *num_str, t_flags *flags, \
			int cnt_chr, size_t *i)
{
...
int			ft_print_x(t_flags *flags, va_list args)
{
	...
	if (!(num_str = ft_to_hex(i, flags->type)))
		return (-1);
	i = 0;
	if (flags->dot == 1)
	{
